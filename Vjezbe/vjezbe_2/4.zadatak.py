...
plt.subplot(1,2,1)
plt.plot(korak,pravokutnik_gornja, color="blue", linestyle="--",label="Gornja pravokutna aproksimacija")
plt.plot(korak,pravokutnik_donja, label="Donja pravokutnika",color="magenta", linestyle="--")
plt.plot(korak, an, color="green", label="Analiticka")
plt.xlabel("n")
plt.ylabel("integral")
plt.legend()
plt.grid(True)
...
plt.subplot(1,2,2)
plt.plot(korak,trapez,label="Trapezna aproksimacija",color="cyan", linestyle="--", linewidth=10)
